...
torch.ops.load_library("bending/transforms/erode/build/liberode.so")
torch.ops.load_library("bending/transforms/dilate/build/libdilate.so")
torch.ops.load_library("bending/transforms/scale/build/libscale.so")
torch.ops.load_library("bending/transforms/rotate/build/librotate.so")
# torch.ops.load_library("/bending/transforms/resize/build/libresize.so")
