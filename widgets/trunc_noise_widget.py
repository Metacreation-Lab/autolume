...
class TruncationNoiseWidget:
    ...
    def get_params(self):
        return (self.trunc_psi, self.trunc_cutoff, self.noise_enable, self.noise_seed, self.noise_anim)

    def set_params(self, params):
        self.trunc_psi, self.trunc_cutoff, self.noise_enable, self.noise_seed, self.noise_anim = params
