...
class DisplayCaptureWidget:
    def __init__(self, viz):
        ...
        # Live upscaling. The checkbox holds the selection, but it only becomes
        # the active pass once its weights are on disk.
    ...
    def _upscale_key(self):
        ...
        return upscale.PERFORM_MODEL if self.upscale_enabled else None
